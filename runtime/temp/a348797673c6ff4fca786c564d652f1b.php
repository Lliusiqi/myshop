<?php /*a:5:{s:77:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\cart\cart_list.html";i:1556071451;s:69:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\layout.html";i:1554295912;s:76:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\public\header.html";i:1555943114;s:73:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\public\nav.html";i:1554778215;s:76:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\public\footer.html";i:1554279032;}*/ ?>
...
<div class="i_bg">  
    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <tr goods_number="<?php echo htmlentities($v['goods_number']); ?>" goods_id="<?php echo htmlentities($v['goods_id']); ?>">
          <td><input type="checkbox" class="box" ></td>
            <td>
            	<div class="c_s_img"><img src="/uploads/<?php echo htmlentities($v['goods_img']); ?>" width="73" height="73" /></div>
               <?php echo htmlentities($v['goods_name']); ?>
            </td>
            <td align="center">
            
             <!--<font color='red'> 比加入时减少了元</font><br>-->
              
            
              <?php echo htmlentities($v['shop_price']); ?>
            
            </td>
            <td align="center">
            	<div class="c_num">
                    <input type="button" class="car_btn_1" />
                	<input type="text" value="<?php echo htmlentities($v['buy_number']); ?>"  class="car_ipt" />  
                    <input type="button"  class="car_btn_2" />
                </div>
            </td>
            <td align="center" style="color:#ff4e00;">￥<?php echo htmlentities($v['shop_price']*$v['buy_number']); ?></td>
        ...
        $(function(){
          ...
          $(".car_btn_2").click(function(){
             ...
             //1、文本框数量+1   同时数据库或cookie中数量发生改变
               ...
               $.ajax({
                 type:'post',
                 url:"<?php echo url('Cart/changeNumber'); ?>",
          ...
          //获取选中的商品id
            ...
            // console.log(goods_id);
           goods_id=goods_id.substr(0,goods_id.length-1);
           location.href="<?php echo url('Cart/conform'); ?>?goods_id="+goods_id;
          });
          })
