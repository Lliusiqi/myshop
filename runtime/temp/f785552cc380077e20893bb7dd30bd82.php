<?php /*a:5:{s:79:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\goods\goods_list.html";i:1557208812;s:69:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\layout.html";i:1554295912;s:76:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\public\header.html";i:1555943114;s:73:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\public\nav.html";i:1554778215;s:76:"D:\phpStudy\PHPTutorial\WWW\myshop\application\index\view\public\footer.html";i:1554279032;}*/ ?>
...
<div class="soubg">
    <div class="sou">
        ...
        <span class="fr">
            <span class="fl">
            <?php if(app('session')->get('userInfo') == ''): ?>
            你好，请<a href="<?php echo url('Login/login'); ?>">登录</a> <a href="<?php echo url('Login/register'); ?>" style="color:#ff4e00;">免费注册</a>|&nbsp;<a href="">&nbsp;&nbsp;</a>
            <?php else: ?>
            欢迎<font color="red"><?php echo htmlentities(app('session')->get('userInfo')['account']); ?></font>登录|&nbsp;
            <a href="<?php echo url('Login/quit'); ?>">退出</a>
            <a href="<?php echo url('User/userList'); ?>">个人中心</a>
            <?php endif; ?>
            </span>
            <span class="ss">
                <div class="ss_list">
    ...
    <div class="menu">
        ...
        <div class="nav">
            ...
            <div class="<?php echo htmlentities($is_show); ?>">
                <ul>  
                <?php if(is_array($cateLeft) || $cateLeft instanceof \think\Collection || $cateLeft instanceof \think\Paginator): $i = 0; $__LIST__ = $cateLeft;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>    
                    <li>
                        <div class="fj">
...
<div class="i_bg">
    ...
    <div class="content mar_10">
    	<table border="0" class="choice" style="width:100%; font-family:'宋体'; margin:0 auto;" cellspacing="0" cellpadding="0">
          <tr valign="top">
            ...
            <a href="javascript:;" class="brand" brand_id="<?php echo htmlentities($v['brand_id']); ?>"><?php echo htmlentities($v['brand_name']); ?></a>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </td>
          </tr>
          <tr valign="top">
            ...
            <a href="javascript:;" class="price"><?php echo htmlentities($v); ?></a>
            <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="content mar_20">
    	<div class="l_history">
        	...
        	<ul>
              <?php if(is_array($historyInfo) || $historyInfo instanceof \think\Collection || $historyInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $historyInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($i % 2 );++$i;?>
            	<li>
                    <div class="img"><a href="<?php echo url('Goods/goodsProduct'); ?>?goods_id=<?php echo htmlentities($a['goods_id']); ?>"><img src="/uploads/<?php echo htmlentities($a['goods_img']); ?>" width="185" height="162" /></a></div>
                	<div class="name"><a href="#"><?php echo htmlentities($a['goods_name']); ?></a></div>
                    <div class="price">
                    	<font>￥<span><?php echo htmlentities($a['shop_price']); ?></span></font> &nbsp; 18R
                    </div>
                </li>
           <?php endforeach; endif; else: echo "" ;endif; ?>
        	</ul>
        ...
        <div class="l_list">
        	<div class="list_t">
            	<span class="fl list_or" id="default">
                    ...
                    <a href="javascript:;" type="2" field="goods_number">
            ...
            <div class="list_c" id="show">
                ...
                <?php if(is_array($goodsInfo) || $goodsInfo instanceof \think\Collection || $goodsInfo instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                	<li>
                    	<div class="img"><a href="<?php echo url('Goods/goodsProduct'); ?>?goods_id=<?php echo htmlentities($v['goods_id']); ?>">
                        <img src="/uploads/<?php echo htmlentities($v['goods_img']); ?>" width="210" height="185" /></a>
                        </div>
                        <div class="price">
                            <font>￥<span><?php echo htmlentities($v['shop_price']); ?></span></font> 
                        </div>
                        <div class="name"><a href="<?php echo url('Goods/goodsProduct'); ?>?goods_id=<?php echo htmlentities($v['goods_id']); ?>"><?php echo htmlentities($v['goods_name']); ?></a></div>
                        <div class="carbg">
    ...
    <script type="text/javascript">
       $(function(){
            ...
            $(".brand").click(function(){
              ...
              $.post(
                 "<?php echo url('Goods/getPriceInfo'); ?>",
                 {brand_id:brand_id},
                 function(res){
                    var _a="";
                    for(var i in res){
                      _a+="<a class='price'>"+res[i]+"</a>";   
                    }
                    // console.log(res);
                    $("#td_a").html(_a);
                    // console.log('aaaaa');
            ...
            function getGoodsInfo(p)
            {
               // console.log(p);
               //获取搜索的条件
              // console.log($("#td_b").children("a[class='brand now']"));
             ...
             // console.log($("#default").children("a[class='now']"));
             ...
             //把条件 页码传给控制器
              $.post(
               ...
               {brand_id:brand_id,price:price,order_field:order_field,order_type:order_type,field:field,p:p},
               function(res){
                // console.log(res);
                $("#show").html(res);
               }
